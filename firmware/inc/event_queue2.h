...
typedef enum btnId
{
    ...
    VOLUP,
    VOLDOWN,
    CANCEL      // << not sure if we will use the NUM___ID in these enums anywhere. I removed them since they are technically invalid inputs >>
} BtnId;
...
// < I made the events a single enum since this is how it's written in the FSM diagram. I'm not dead set on keeping it like this though >
